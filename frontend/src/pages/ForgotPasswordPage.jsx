...
const ForgotPasswordPage = () => {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 px-4 relative">
            <div className="absolute top-4 right-4">
                <ThemeToggle />
            </div>
            <div className="w-full max-w-md bg-white/90 dark:bg-gray-800/95 backdrop-blur-lg rounded-2xl shadow-2xl p-8 transform transition-all">
                {/* Header */}
